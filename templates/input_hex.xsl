...
<xsl:attribute name = "rmt"><xsl:value-of select="@rmt"/></xsl:attribute>
	<atom coord="0.0 0.0 0.25" />
    <atom coord="0.0 0.0 0.75" />
    <atom coord="0.333333333 0.666666667 0.25" />
    <atom coord="0.666666667 0.333333333 0.75" />
</species>
</structure>
